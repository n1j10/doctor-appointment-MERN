...
function DoctorDetails() {
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl p-8 bg-gray-50 ml-auto mr-auto h-40'>

        <div className='md:col-span-2 flex flex-col md:flex-row items-center h-40'>
