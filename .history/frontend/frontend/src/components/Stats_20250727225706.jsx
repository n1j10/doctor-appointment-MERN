        ...
        <div className='max-w-6xl mx-auto px-4 '>
            <div className='grid lg:grid-cols-4  md:grid-cols-2 sm:grid-cols-1 gap-4'>
                ...
                {stats.map((item,index)=> (
                    <div  className=" cursor-pointer flex items-center justify-start space-x-4 bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition hover:bg-[#008e9b] transition " key={index}>
