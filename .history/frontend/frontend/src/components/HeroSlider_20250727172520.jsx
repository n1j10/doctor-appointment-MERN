...
import carousel_1 from "../../src/img/hero-carousel/hero-carousel/hero-carousel-1.jpg"

import carousel_2 from "../../src/img/hero-carousel/hero-carousel/hero-carousel-2.jpg"


import carousel_3 from "../../src/img/hero-carousel/hero-carousel/hero-carousel-3.jpg"
    ...
    <section className='relative w-full h-[80vh] overflow-hidden' >
        <Slider {...settings}>
            ...
            <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center text-center text-white px-4">
             ...
             <a className="mt-6 inline-block bg-blue-600 px-6 py-3 rounded hover:bg-blue-700">
              Read More
