  ...
  return (
    <div className='p-8 bg-gray-100 min-h-screen'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto'>
              ...
              <div className="flex  items-center justify-center float-right mt-8">
                    <Link className='bg-[#008e9b] w-100 text-white px-6 rounded text-center hover:bg-[#007885] transition ' to="/allDoctors">
