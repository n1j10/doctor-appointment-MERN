  ...
  return (
    <section className="py-16 bg-gray-50">
        ...
        <div className='max-w-6xl mx-auto grid sm:grid-cols-1 md:grid-cols-2 gap-8 px-4'>
            ...
            <div>
                <h3 className='text-2xl font-semibold mb-4'>We are committed to providing trusted healthcare services with skilled professionals, advanced technology, and compassionate care to ensure your well-being.</h3>
