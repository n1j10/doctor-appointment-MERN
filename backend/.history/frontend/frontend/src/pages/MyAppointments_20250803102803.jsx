...
const MyAppointments = () => {
  ...
  const cancelAppointment = async (id) => {
    try {
      ...
      // Option 1: If you changed backend to DELETE method
      ...
      // Option 2: If you kept POST method with new route
      // const res = await fetch(`http://localhost:5000/appointments/delete/${id}`, {
      //   method: "POST",
      //   headers: { 
      //     Authorization: `Bearer ${token}`,
      //     "Content-Type": "application/json"
