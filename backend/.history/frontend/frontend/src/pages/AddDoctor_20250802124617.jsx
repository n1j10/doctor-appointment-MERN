    ...
    <div  className="flex justify-center items-center h-screen bg-gray-100">
        <form className='bg-white shadow-lg rounded-lg p-8 w-full max-w-3xl flex gap-8' encType="multipart/form-data">
            ...
            <div className="w-2/3">
              ...
              <input onChange={handleChange} type='text' name="name"  required className="w-full mb-4 p-2 border rounded"/>


                  <label className="block mb-2 font-semibold">Specialty</label>

              <input onChange={handleChange} type='text' name="Specialty"  required className="w-full mb-4 p-2 border rounded"/>



                  <label className="block mb-2 font-semibold">Experience Years</label>

              <input onChange={handleChange} type='text' name="experienceYears"  required className="w-full mb-4 p-2 border rounded"/>
